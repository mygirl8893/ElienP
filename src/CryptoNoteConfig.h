...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1161198; // addresses start with "gxy"
const size_t   CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 10; // 30mins
...
const uint64_t DIFFICULTY_TARGET                             = 180; // LWMA-2
